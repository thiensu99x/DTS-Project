...
exports.run = async function (o) {
    ...
    if (bet <= 0 || bet > (await o.Currencies.getData(o.event.senderID)).money) return send(`[⚜️] ➜ Bạn phải cược tiền để chơi\n[💵] ➜ Số tiền cược không hợp lệ hoặc bạn không đủ tiền!`);
