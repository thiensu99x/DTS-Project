  ...
  try {
    ...
    if(!args[0] || isNaN(args[0]) == true || args[0] == "help") {
      if(!fs.existsSync(__dirname+"/cache/hexcolor.png")) {
       let getimg = (await axios.get(`https://blog.webico.vn/wp-content/uploads/2016/05/1L.png`, { responseType: "arraybuffer" })).data;
