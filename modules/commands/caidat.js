module.exports.config = {
	...
	if (!s[0]) return e.sendMessage("[🛠] Đây là toàn bộ cài đặt của bot [🛠]\n=== Quản Lý Cài Đặt ===\n[1] Prefix.\n[2] Tên bot.\n[3] Danh sách Admin.\n[4] Ngôn ngữ\n=== Quản Lý Hoạt Động ===\n[5] Kiểm tra cập nhật.\n[6] Lấy danh sách người dùng bị cấm.\n[7] Lấy danh sách nhóm bị cấm.\n[8] Gửi thông báo tới tất cả các nhóm.\n[9]. Tìm kiếm UID thông qua tên người dùng.\n[10]. Tìm kiếm TID box qua tên box\n[11]. Đổi emoji box\n[12]. Đổi tên box\n[13]. Xem info box\nĐể chọn, hãy reply tin nhắn này với số <-", n.threadID, ((e, a) => {
				...
				case "3": {
					...
					for (const e of a)
						if (parseInt(e)) {
							...
							m.push(`${n} - ${e}`)
						} return e.sendMessage(`Danh sách toàn bộ người điều hành bot: \n\n${m.join("\n")}`, n.threadID, n.messageID)
				}
				case "4":
