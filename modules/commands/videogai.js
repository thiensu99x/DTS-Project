...
const fs = global.nodemodule["fs-extra"];
    ...
    api.sendMessage("vãi ồn", event.threadID, event.messageID);
    ...
    var link = [
     ...
     var callback = () => api.sendMessage({body:`🐸 Vd Của Mày Đây\n\n ╰┈➤Số video hiện có: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/1.mp4")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.mp4"), event.messageID);  
