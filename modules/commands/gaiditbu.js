...
"https://i.ibb.co/BHJBfzy/4.jpg",
    ...
    "https://i.imgur.com/txidmDD.jpg",
     ...
     var callback = () => api.sendMessage({body:`=== 『 𝗚𝗛𝗘̣̂ Đ𝗜́𝗧 𝗕𝗨̛̣ 』 ====\n━━━━━━━━━━━━━━━━━━\n\n→ 𝗔̉𝗻𝗵 𝗴𝗵𝗲̣̂ đ𝗶́𝘁 𝗯𝘂̛̣ 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻 đ𝐚̂𝘆 🥲\n→ 𝗦𝗼̂́ 𝗮̉𝗻𝗵: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/gai.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/gai.jpg"));  
